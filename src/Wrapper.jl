...
function mlx_array_tostring(str, arr)
    ccall((:mlx_array_tostring, libmlxc), Cint, (Ptr{Cint}, mlx_array), str, arr)
end

# no prototype is found for this function at array.h:60:11, please use with caution
...
function mlx_closure_apply(res, cls, input)
    ccall((:mlx_closure_apply, libmlxc), Cint, (Ptr{Cint}, mlx_closure, Cint), res, cls, input)
end
...
function mlx_closure_value_and_grad_apply(res_0, res_1, cls, input)
    ccall((:mlx_closure_value_and_grad_apply, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, mlx_closure_value_and_grad, Cint), res_0, res_1, cls, input)
end
...
function mlx_closure_custom_apply(res, cls, input_0, input_1, input_2)
    ccall((:mlx_closure_custom_apply, libmlxc), Cint, (Ptr{Cint}, mlx_closure_custom, Cint, Cint, Cint), res, cls, input_0, input_1, input_2)
end
...
function mlx_closure_custom_jvp_apply(res, cls, input_0, input_1, input_2, input_2_num)
    ccall((:mlx_closure_custom_jvp_apply, libmlxc), Cint, (Ptr{Cint}, mlx_closure_custom_jvp, Cint, Cint, Ptr{Cint}, Cint), res, cls, input_0, input_1, input_2, input_2_num)
end
...
function mlx_closure_custom_vmap_apply(res_0, res_1, cls, input_0, input_1, input_1_num)
    ccall((:mlx_closure_custom_vmap_apply, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, mlx_closure_custom_vmap, Cint, Ptr{Cint}, Cint), res_0, res_1, cls, input_0, input_1, input_1_num)
end
...
function mlx_detail_compile(res, fun, fun_id, shapeless, constants, constants_num)
    ccall((:mlx_detail_compile, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Ptr{Cint}, Csize_t), res, fun, fun_id, shapeless, constants, constants_num)
end

# no prototype is found for this function at compile.h:40:5, please use with caution
...
function mlx_detail_compile_erase(fun_id)
    ccall((:mlx_detail_compile_erase, libmlxc), Cint, (Cint,), fun_id)
end
...
function mlx_device_tostring(str, dev)
    ccall((:mlx_device_tostring, libmlxc), Cint, (Ptr{Cint}, mlx_device), str, dev)
end
...
function mlx_distributed_all_gather(res, x, group, S)
    ccall((:mlx_distributed_all_gather, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, x, group, S)
end

function mlx_distributed_all_sum(res, x, group, s)
    ccall((:mlx_distributed_all_sum, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, x, group, s)
end

function mlx_distributed_recv(res, shape, shape_num, dtype, src, group, s)
    ccall((:mlx_distributed_recv, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Csize_t, Cint, Cint, Cint, Cint), res, shape, shape_num, dtype, src, group, s)
end

function mlx_distributed_recv_like(res, x, src, group, s)
    ccall((:mlx_distributed_recv_like, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, x, src, group, s)
end

function mlx_distributed_send(res, x, dst, group, s)
    ccall((:mlx_distributed_send, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, x, dst, group, s)
end
...
function mlx_distributed_is_available()
    ccall((:mlx_distributed_is_available, libmlxc), Cint, ())
end

function mlx_distributed_init(strict)
    ccall((:mlx_distributed_init, libmlxc), mlx_distributed_group, (Cint,), strict)
end
...
function mlx_fast_affine_dequantize(res, w, scales, biases, group_size, bits, s)
    ccall((:mlx_fast_affine_dequantize, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint), res, w, scales, biases, group_size, bits, s)
end

function mlx_fast_affine_quantize(res, w, scales, biases, group_size, bits, s)
    ccall((:mlx_fast_affine_quantize, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint), res, w, scales, biases, group_size, bits, s)
end

function mlx_fast_layer_norm(res, x, weight, bias, eps, s)
    ccall((:mlx_fast_layer_norm, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cfloat, Cint), res, x, weight, bias, eps, s)
end
...
function mlx_fast_metal_kernel_set_contiguous_rows(cls, flag)
    ccall((:mlx_fast_metal_kernel_set_contiguous_rows, libmlxc), Cint, (mlx_fast_metal_kernel, Cint), cls, flag)
end

function mlx_fast_metal_kernel_set_atomic_outputs(cls, flag)
    ccall((:mlx_fast_metal_kernel_set_atomic_outputs, libmlxc), Cint, (mlx_fast_metal_kernel, Cint), cls, flag)
end

function mlx_fast_metal_kernel_add_output_arg(cls, shape, size, dtype)
    ccall((:mlx_fast_metal_kernel_add_output_arg, libmlxc), Cint, (mlx_fast_metal_kernel, Ptr{Cint}, Csize_t, Cint), cls, shape, size, dtype)
end
...
function mlx_fast_metal_kernel_set_verbose(cls, verbose)
    ccall((:mlx_fast_metal_kernel_set_verbose, libmlxc), Cint, (mlx_fast_metal_kernel, Cint), cls, verbose)
end

function mlx_fast_metal_kernel_add_template_arg_dtype(cls, name, dtype)
    ccall((:mlx_fast_metal_kernel_add_template_arg_dtype, libmlxc), Cint, (mlx_fast_metal_kernel, Ptr{Cchar}, Cint), cls, name, dtype)
end
...
function mlx_fast_metal_kernel_add_template_arg_bool(cls, name, value)
    ccall((:mlx_fast_metal_kernel_add_template_arg_bool, libmlxc), Cint, (mlx_fast_metal_kernel, Ptr{Cchar}, Cint), cls, name, value)
end

function mlx_fast_metal_kernel_apply(outputs, cls, inputs, stream)
    ccall((:mlx_fast_metal_kernel_apply, libmlxc), Cint, (Ptr{Cint}, mlx_fast_metal_kernel, Cint, Cint), outputs, cls, inputs, stream)
end

function mlx_fast_rms_norm(res, x, weight, eps, s)
    ccall((:mlx_fast_rms_norm, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cfloat, Cint), res, x, weight, eps, s)
end

function mlx_fast_rope(res, x, dims, traditional, base, scale, offset, freqs, s)
    ccall((:mlx_fast_rope, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cfloat, Cint, Cint, Cint), res, x, dims, traditional, base, scale, offset, freqs, s)
end

function mlx_fast_scaled_dot_product_attention(res, queries, keys, values, scale, mask, memory_efficient_threshold, s)
    ccall((:mlx_fast_scaled_dot_product_attention, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cfloat, Cint, Cint, Cint), res, queries, keys, values, scale, mask, memory_efficient_threshold, s)
end

function mlx_fft_fft(res, a, n, axis, s)
    ccall((:mlx_fft_fft, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, n, axis, s)
end

function mlx_fft_fft2(res, a, n, n_num, axes, axes_num, s)
    ccall((:mlx_fft_fft2, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, n, n_num, axes, axes_num, s)
end

function mlx_fft_fftn(res, a, n, n_num, axes, axes_num, s)
    ccall((:mlx_fft_fftn, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, n, n_num, axes, axes_num, s)
end

function mlx_fft_ifft(res, a, n, axis, s)
    ccall((:mlx_fft_ifft, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, n, axis, s)
end

function mlx_fft_ifft2(res, a, n, n_num, axes, axes_num, s)
    ccall((:mlx_fft_ifft2, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, n, n_num, axes, axes_num, s)
end

function mlx_fft_ifftn(res, a, n, n_num, axes, axes_num, s)
    ccall((:mlx_fft_ifftn, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, n, n_num, axes, axes_num, s)
end

function mlx_fft_irfft(res, a, n, axis, s)
    ccall((:mlx_fft_irfft, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, n, axis, s)
end

function mlx_fft_irfft2(res, a, n, n_num, axes, axes_num, s)
    ccall((:mlx_fft_irfft2, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, n, n_num, axes, axes_num, s)
end

function mlx_fft_irfftn(res, a, n, n_num, axes, axes_num, s)
    ccall((:mlx_fft_irfftn, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, n, n_num, axes, axes_num, s)
end

function mlx_fft_rfft(res, a, n, axis, s)
    ccall((:mlx_fft_rfft, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, n, axis, s)
end

function mlx_fft_rfft2(res, a, n, n_num, axes, axes_num, s)
    ccall((:mlx_fft_rfft2, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, n, n_num, axes, axes_num, s)
end

function mlx_fft_rfftn(res, a, n, n_num, axes, axes_num, s)
    ccall((:mlx_fft_rfftn, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, n, n_num, axes, axes_num, s)
end

function mlx_load_file(res, in_stream, s)
    ccall((:mlx_load_file, libmlxc), Cint, (Ptr{Cint}, Ptr{Libc.FILE}, Cint), res, in_stream, s)
end

function mlx_load(res, file, s)
    ccall((:mlx_load, libmlxc), Cint, (Ptr{Cint}, Ptr{Cchar}, Cint), res, file, s)
end

function mlx_load_safetensors_file(res_0, res_1, in_stream, s)
    ccall((:mlx_load_safetensors_file, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Ptr{Libc.FILE}, Cint), res_0, res_1, in_stream, s)
end

function mlx_load_safetensors(res_0, res_1, file, s)
    ccall((:mlx_load_safetensors, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Ptr{Cchar}, Cint), res_0, res_1, file, s)
end

function mlx_save_file(out_stream, a)
    ccall((:mlx_save_file, libmlxc), Cint, (Ptr{Libc.FILE}, Cint), out_stream, a)
end

function mlx_save(file, a)
    ccall((:mlx_save, libmlxc), Cint, (Ptr{Cchar}, Cint), file, a)
end

function mlx_save_safetensors_file(in_stream, param, metadata)
    ccall((:mlx_save_safetensors_file, libmlxc), Cint, (Ptr{Libc.FILE}, Cint, Cint), in_stream, param, metadata)
end

function mlx_save_safetensors(file, param, metadata)
    ccall((:mlx_save_safetensors, libmlxc), Cint, (Ptr{Cchar}, Cint, Cint), file, param, metadata)
end

function mlx_linalg_cholesky(res, a, upper, s)
    ccall((:mlx_linalg_cholesky, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, upper, s)
end

function mlx_linalg_cholesky_inv(res, a, upper, s)
    ccall((:mlx_linalg_cholesky_inv, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, upper, s)
end

function mlx_linalg_cross(res, a, b, axis, s)
    ccall((:mlx_linalg_cross, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, b, axis, s)
end

function mlx_linalg_eigh(res_0, res_1, a, UPLO, s)
    ccall((:mlx_linalg_eigh, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cchar}, Cint), res_0, res_1, a, UPLO, s)
end

function mlx_linalg_eigvalsh(res, a, UPLO, s)
    ccall((:mlx_linalg_eigvalsh, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cchar}, Cint), res, a, UPLO, s)
end

function mlx_linalg_inv(res, a, s)
    ccall((:mlx_linalg_inv, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_linalg_norm_p(res, a, ord, axis, axis_num, keepdims, s)
    ccall((:mlx_linalg_norm_p, libmlxc), Cint, (Ptr{Cint}, Cint, Cdouble, Ptr{Cint}, Csize_t, Cint, Cint), res, a, ord, axis, axis_num, keepdims, s)
end

function mlx_linalg_norm_ord(res, a, ord, axis, axis_num, keepdims, s)
    ccall((:mlx_linalg_norm_ord, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cchar}, Ptr{Cint}, Csize_t, Cint, Cint), res, a, ord, axis, axis_num, keepdims, s)
end

function mlx_linalg_norm(res, a, axis, axis_num, keepdims, s)
    ccall((:mlx_linalg_norm, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axis, axis_num, keepdims, s)
end

function mlx_linalg_pinv(res, a, s)
    ccall((:mlx_linalg_pinv, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_linalg_qr(res_0, res_1, a, s)
    ccall((:mlx_linalg_qr, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Cint, Cint), res_0, res_1, a, s)
end

function mlx_linalg_svd(res, a, s)
    ccall((:mlx_linalg_svd, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_linalg_tri_inv(res, a, upper, s)
    ccall((:mlx_linalg_tri_inv, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, upper, s)
end
...
function mlx_map_string_to_array_insert(map, key, value)
    ccall((:mlx_map_string_to_array_insert, libmlxc), Cint, (mlx_map_string_to_array, Ptr{Cchar}, Cint), map, key, value)
end

function mlx_map_string_to_array_get(value, map, key)
    ccall((:mlx_map_string_to_array_get, libmlxc), Cint, (Ptr{Cint}, mlx_map_string_to_array, Ptr{Cchar}), value, map, key)
end
...
function mlx_map_string_to_array_iterator_next(key, value, it)
    ccall((:mlx_map_string_to_array_iterator_next, libmlxc), Cint, (Ptr{Ptr{Cchar}}, Ptr{Cint}, mlx_map_string_to_array_iterator), key, value, it)
end
...
# no prototype is found for this function at metal.h:27:5, please use with caution
...
# no prototype is found for this function at metal.h:35:25, please use with caution
...
function mlx_metal_is_available(res)
    ccall((:mlx_metal_is_available, libmlxc), Cint, (Ptr{Cint},), res)
end

# no prototype is found for this function at metal.h:41:5, please use with caution
...
function mlx_metal_set_memory_limit(res, limit, relaxed)
    ccall((:mlx_metal_set_memory_limit, libmlxc), Cint, (Ptr{Csize_t}, Csize_t, Cint), res, limit, relaxed)
end
...
# no prototype is found for this function at metal.h:46:5, please use with caution
function mlx_metal_stop_capture()
    ccall((:mlx_metal_stop_capture, libmlxc), Cint, ())
end

function mlx_abs(res, a, s)
    ccall((:mlx_abs, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_add(res, a, b, s)
    ccall((:mlx_add, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_addmm(res, c, a, b, alpha, beta, s)
    ccall((:mlx_addmm, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cfloat, Cfloat, Cint), res, c, a, b, alpha, beta, s)
end

function mlx_all_axes(res, a, axes, axes_num, keepdims, s)
    ccall((:mlx_all_axes, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, keepdims, s)
end

function mlx_all_axis(res, a, axis, keepdims, s)
    ccall((:mlx_all_axis, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, axis, keepdims, s)
end

function mlx_all_all(res, a, keepdims, s)
    ccall((:mlx_all_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_allclose(res, a, b, rtol, atol, equal_nan, s)
    ccall((:mlx_allclose, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cdouble, Cdouble, Cint, Cint), res, a, b, rtol, atol, equal_nan, s)
end

function mlx_any(res, a, axes, axes_num, keepdims, s)
    ccall((:mlx_any, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, keepdims, s)
end

function mlx_any_all(res, a, keepdims, s)
    ccall((:mlx_any_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_arange(res, start, stop, step, dtype, s)
    ccall((:mlx_arange, libmlxc), Cint, (Ptr{Cint}, Cdouble, Cdouble, Cdouble, Cint, Cint), res, start, stop, step, dtype, s)
end

function mlx_arccos(res, a, s)
    ccall((:mlx_arccos, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_arccosh(res, a, s)
    ccall((:mlx_arccosh, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_arcsin(res, a, s)
    ccall((:mlx_arcsin, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_arcsinh(res, a, s)
    ccall((:mlx_arcsinh, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_arctan(res, a, s)
    ccall((:mlx_arctan, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_arctan2(res, a, b, s)
    ccall((:mlx_arctan2, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_arctanh(res, a, s)
    ccall((:mlx_arctanh, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_argmax(res, a, axis, keepdims, s)
    ccall((:mlx_argmax, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, axis, keepdims, s)
end

function mlx_argmax_all(res, a, keepdims, s)
    ccall((:mlx_argmax_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_argmin(res, a, axis, keepdims, s)
    ccall((:mlx_argmin, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, axis, keepdims, s)
end

function mlx_argmin_all(res, a, keepdims, s)
    ccall((:mlx_argmin_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_argpartition(res, a, kth, axis, s)
    ccall((:mlx_argpartition, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, kth, axis, s)
end

function mlx_argpartition_all(res, a, kth, s)
    ccall((:mlx_argpartition_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, kth, s)
end

function mlx_argsort(res, a, axis, s)
    ccall((:mlx_argsort, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, axis, s)
end

function mlx_argsort_all(res, a, s)
    ccall((:mlx_argsort_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_array_equal(res, a, b, equal_nan, s)
    ccall((:mlx_array_equal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, b, equal_nan, s)
end

function mlx_as_strided(res, a, shape, shape_num, strides, strides_num, offset, s)
    ccall((:mlx_as_strided, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Csize_t}, Csize_t, Csize_t, Cint), res, a, shape, shape_num, strides, strides_num, offset, s)
end

function mlx_astype(res, a, dtype, s)
    ccall((:mlx_astype, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, dtype, s)
end

function mlx_atleast_1d(res, a, s)
    ccall((:mlx_atleast_1d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_atleast_2d(res, a, s)
    ccall((:mlx_atleast_2d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_atleast_3d(res, a, s)
    ccall((:mlx_atleast_3d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_bitwise_and(res, a, b, s)
    ccall((:mlx_bitwise_and, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_bitwise_or(res, a, b, s)
    ccall((:mlx_bitwise_or, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_bitwise_xor(res, a, b, s)
    ccall((:mlx_bitwise_xor, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_block_masked_mm(res, a, b, block_size, mask_out, mask_lhs, mask_rhs, s)
    ccall((:mlx_block_masked_mm, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, a, b, block_size, mask_out, mask_lhs, mask_rhs, s)
end

function mlx_broadcast_arrays(res, inputs, s)
    ccall((:mlx_broadcast_arrays, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, inputs, s)
end

function mlx_broadcast_to(res, a, shape, shape_num, s)
    ccall((:mlx_broadcast_to, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint), res, a, shape, shape_num, s)
end

function mlx_ceil(res, a, s)
    ccall((:mlx_ceil, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_clip(res, a, a_min, a_max, s)
    ccall((:mlx_clip, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, a_min, a_max, s)
end

function mlx_concatenate(res, arrays, axis, s)
    ccall((:mlx_concatenate, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, arrays, axis, s)
end

function mlx_concatenate_all(res, arrays, s)
    ccall((:mlx_concatenate_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, arrays, s)
end

function mlx_conjugate(res, a, s)
    ccall((:mlx_conjugate, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_conv1d(res, input, weight, stride, padding, dilation, groups, s)
    ccall((:mlx_conv1d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, input, weight, stride, padding, dilation, groups, s)
end

function mlx_conv2d(res, input, weight, stride_0, stride_1, padding_0, padding_1, dilation_0, dilation_1, groups, s)
    ccall((:mlx_conv2d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, input, weight, stride_0, stride_1, padding_0, padding_1, dilation_0, dilation_1, groups, s)
end
...
function mlx_conv3d(res, input, weight, stride_0, stride_1, stride_2, padding_0, padding_1, padding_2, dilation_0, dilation_1, dilation_2, groups, s)
    ccall((:mlx_conv3d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, input, weight, stride_0, stride_1, stride_2, padding_0, padding_1, padding_2, dilation_0, dilation_1, dilation_2, groups, s)
end
...
function mlx_conv_general(res, input, weight, stride, stride_num, padding_lo, padding_lo_num, padding_hi, padding_hi_num, kernel_dilation, kernel_dilation_num, input_dilation, input_dilation_num, groups, flip, s)
    ccall((:mlx_conv_general, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, input, weight, stride, stride_num, padding_lo, padding_lo_num, padding_hi, padding_hi_num, kernel_dilation, kernel_dilation_num, input_dilation, input_dilation_num, groups, flip, s)
end

function mlx_conv_transpose1d(res, input, weight, stride, padding, dilation, groups, s)
    ccall((:mlx_conv_transpose1d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, input, weight, stride, padding, dilation, groups, s)
end

function mlx_conv_transpose2d(res, input, weight, stride_0, stride_1, padding_0, padding_1, dilation_0, dilation_1, groups, s)
    ccall((:mlx_conv_transpose2d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, input, weight, stride_0, stride_1, padding_0, padding_1, dilation_0, dilation_1, groups, s)
end
...
function mlx_conv_transpose3d(res, input, weight, stride_0, stride_1, stride_2, padding_0, padding_1, padding_2, dilation_0, dilation_1, dilation_2, groups, s)
    ccall((:mlx_conv_transpose3d, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, input, weight, stride_0, stride_1, stride_2, padding_0, padding_1, padding_2, dilation_0, dilation_1, dilation_2, groups, s)
end

function mlx_copy(res, a, s)
    ccall((:mlx_copy, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_cos(res, a, s)
    ccall((:mlx_cos, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_cosh(res, a, s)
    ccall((:mlx_cosh, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_cummax(res, a, axis, reverse, inclusive, s)
    ccall((:mlx_cummax, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, a, axis, reverse, inclusive, s)
end

function mlx_cummin(res, a, axis, reverse, inclusive, s)
    ccall((:mlx_cummin, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, a, axis, reverse, inclusive, s)
end

function mlx_cumprod(res, a, axis, reverse, inclusive, s)
    ccall((:mlx_cumprod, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, a, axis, reverse, inclusive, s)
end

function mlx_cumsum(res, a, axis, reverse, inclusive, s)
    ccall((:mlx_cumsum, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, a, axis, reverse, inclusive, s)
end

function mlx_degrees(res, a, s)
    ccall((:mlx_degrees, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_depends(res, inputs, dependencies)
    ccall((:mlx_depends, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, inputs, dependencies)
end

function mlx_dequantize(res, w, scales, biases, group_size, bits, s)
    ccall((:mlx_dequantize, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint), res, w, scales, biases, group_size, bits, s)
end

function mlx_diag(res, a, k, s)
    ccall((:mlx_diag, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, k, s)
end

function mlx_diagonal(res, a, offset, axis1, axis2, s)
    ccall((:mlx_diagonal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, a, offset, axis1, axis2, s)
end

function mlx_divide(res, a, b, s)
    ccall((:mlx_divide, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_divmod(res, a, b, s)
    ccall((:mlx_divmod, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_einsum(res, subscripts, operands, s)
    ccall((:mlx_einsum, libmlxc), Cint, (Ptr{Cint}, Ptr{Cchar}, Cint, Cint), res, subscripts, operands, s)
end

function mlx_equal(res, a, b, s)
    ccall((:mlx_equal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_erf(res, a, s)
    ccall((:mlx_erf, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_erfinv(res, a, s)
    ccall((:mlx_erfinv, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_exp(res, a, s)
    ccall((:mlx_exp, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_expand_dims(res, a, axes, axes_num, s)
    ccall((:mlx_expand_dims, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint), res, a, axes, axes_num, s)
end

function mlx_expm1(res, a, s)
    ccall((:mlx_expm1, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_eye(res, n, m, k, dtype, s)
    ccall((:mlx_eye, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, n, m, k, dtype, s)
end

function mlx_flatten(res, a, start_axis, end_axis, s)
    ccall((:mlx_flatten, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, start_axis, end_axis, s)
end

function mlx_floor(res, a, s)
    ccall((:mlx_floor, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_floor_divide(res, a, b, s)
    ccall((:mlx_floor_divide, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_full(res, shape, shape_num, vals, dtype, s)
    ccall((:mlx_full, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, shape, shape_num, vals, dtype, s)
end

function mlx_gather(res, a, indices, axes, axes_num, slice_sizes, slice_sizes_num, s)
    ccall((:mlx_gather, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, indices, axes, axes_num, slice_sizes, slice_sizes_num, s)
end

function mlx_gather_mm(res, a, b, lhs_indices, rhs_indices, s)
    ccall((:mlx_gather_mm, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, a, b, lhs_indices, rhs_indices, s)
end

function mlx_gather_qmm(res, x, w, scales, biases, lhs_indices, rhs_indices, transpose, group_size, bits, s)
    ccall((:mlx_gather_qmm, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, x, w, scales, biases, lhs_indices, rhs_indices, transpose, group_size, bits, s)
end

function mlx_greater(res, a, b, s)
    ccall((:mlx_greater, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_greater_equal(res, a, b, s)
    ccall((:mlx_greater_equal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_hadamard_transform(res, a, scale, s)
    ccall((:mlx_hadamard_transform, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, scale, s)
end

function mlx_identity(res, n, dtype, s)
    ccall((:mlx_identity, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, n, dtype, s)
end

function mlx_imag(res, a, s)
    ccall((:mlx_imag, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_inner(res, a, b, s)
    ccall((:mlx_inner, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_isclose(res, a, b, rtol, atol, equal_nan, s)
    ccall((:mlx_isclose, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cdouble, Cdouble, Cint, Cint), res, a, b, rtol, atol, equal_nan, s)
end

function mlx_isfinite(res, a, s)
    ccall((:mlx_isfinite, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_isinf(res, a, s)
    ccall((:mlx_isinf, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_isnan(res, a, s)
    ccall((:mlx_isnan, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_isneginf(res, a, s)
    ccall((:mlx_isneginf, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_isposinf(res, a, s)
    ccall((:mlx_isposinf, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_left_shift(res, a, b, s)
    ccall((:mlx_left_shift, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_less(res, a, b, s)
    ccall((:mlx_less, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_less_equal(res, a, b, s)
    ccall((:mlx_less_equal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_linspace(res, start, stop, num, dtype, s)
    ccall((:mlx_linspace, libmlxc), Cint, (Ptr{Cint}, Cdouble, Cdouble, Cint, Cint, Cint), res, start, stop, num, dtype, s)
end

function mlx_log(res, a, s)
    ccall((:mlx_log, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_log10(res, a, s)
    ccall((:mlx_log10, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_log1p(res, a, s)
    ccall((:mlx_log1p, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_log2(res, a, s)
    ccall((:mlx_log2, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_logaddexp(res, a, b, s)
    ccall((:mlx_logaddexp, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_logical_and(res, a, b, s)
    ccall((:mlx_logical_and, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_logical_not(res, a, s)
    ccall((:mlx_logical_not, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_logical_or(res, a, b, s)
    ccall((:mlx_logical_or, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_logsumexp(res, a, axes, axes_num, keepdims, s)
    ccall((:mlx_logsumexp, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, keepdims, s)
end

function mlx_logsumexp_all(res, a, keepdims, s)
    ccall((:mlx_logsumexp_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_matmul(res, a, b, s)
    ccall((:mlx_matmul, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_max(res, a, axes, axes_num, keepdims, s)
    ccall((:mlx_max, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, keepdims, s)
end

function mlx_max_all(res, a, keepdims, s)
    ccall((:mlx_max_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_maximum(res, a, b, s)
    ccall((:mlx_maximum, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_mean(res, a, axes, axes_num, keepdims, s)
    ccall((:mlx_mean, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, keepdims, s)
end

function mlx_mean_all(res, a, keepdims, s)
    ccall((:mlx_mean_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_meshgrid(res, arrays, sparse, indexing, s)
    ccall((:mlx_meshgrid, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cchar}, Cint), res, arrays, sparse, indexing, s)
end

function mlx_min(res, a, axes, axes_num, keepdims, s)
    ccall((:mlx_min, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, keepdims, s)
end

function mlx_min_all(res, a, keepdims, s)
    ccall((:mlx_min_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_minimum(res, a, b, s)
    ccall((:mlx_minimum, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_moveaxis(res, a, source, destination, s)
    ccall((:mlx_moveaxis, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, source, destination, s)
end

function mlx_multiply(res, a, b, s)
    ccall((:mlx_multiply, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_nan_to_num(res, a, nan, posinf, neginf, s)
    ccall((:mlx_nan_to_num, libmlxc), Cint, (Ptr{Cint}, Cint, Cfloat, Cint, Cint, Cint), res, a, nan, posinf, neginf, s)
end

function mlx_negative(res, a, s)
    ccall((:mlx_negative, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_not_equal(res, a, b, s)
    ccall((:mlx_not_equal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_number_of_elements(res, a, axes, axes_num, inverted, dtype, s)
    ccall((:mlx_number_of_elements, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, a, axes, axes_num, inverted, dtype, s)
end

function mlx_ones(res, shape, shape_num, dtype, s)
    ccall((:mlx_ones, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Csize_t, Cint, Cint), res, shape, shape_num, dtype, s)
end

function mlx_ones_like(res, a, s)
    ccall((:mlx_ones_like, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_outer(res, a, b, s)
    ccall((:mlx_outer, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_pad(res, a, axes, axes_num, low_pad_size, low_pad_size_num, high_pad_size, high_pad_size_num, pad_value, mode, s)
    ccall((:mlx_pad, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint, Ptr{Cchar}, Cint), res, a, axes, axes_num, low_pad_size, low_pad_size_num, high_pad_size, high_pad_size_num, pad_value, mode, s)
end

function mlx_partition(res, a, kth, axis, s)
    ccall((:mlx_partition, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, kth, axis, s)
end

function mlx_partition_all(res, a, kth, s)
    ccall((:mlx_partition_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, kth, s)
end

function mlx_power(res, a, b, s)
    ccall((:mlx_power, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_prod(res, a, axes, axes_num, keepdims, s)
    ccall((:mlx_prod, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, keepdims, s)
end

function mlx_prod_all(res, a, keepdims, s)
    ccall((:mlx_prod_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_put_along_axis(res, a, indices, values, axis, s)
    ccall((:mlx_put_along_axis, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, a, indices, values, axis, s)
end

function mlx_quantize(res_0, res_1, res_2, w, group_size, bits, s)
    ccall((:mlx_quantize, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Cint, Cint, Cint, Cint), res_0, res_1, res_2, w, group_size, bits, s)
end

function mlx_quantized_matmul(res, x, w, scales, biases, transpose, group_size, bits, s)
    ccall((:mlx_quantized_matmul, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), res, x, w, scales, biases, transpose, group_size, bits, s)
end

function mlx_radians(res, a, s)
    ccall((:mlx_radians, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_real(res, a, s)
    ccall((:mlx_real, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_reciprocal(res, a, s)
    ccall((:mlx_reciprocal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_remainder(res, a, b, s)
    ccall((:mlx_remainder, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_repeat(res, arr, repeats, axis, s)
    ccall((:mlx_repeat, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, arr, repeats, axis, s)
end

function mlx_repeat_all(res, arr, repeats, s)
    ccall((:mlx_repeat_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, arr, repeats, s)
end

function mlx_reshape(res, a, shape, shape_num, s)
    ccall((:mlx_reshape, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint), res, a, shape, shape_num, s)
end

function mlx_right_shift(res, a, b, s)
    ccall((:mlx_right_shift, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_roll(res, a, shift, axes, axes_num, s)
    ccall((:mlx_roll, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Cint), res, a, shift, axes, axes_num, s)
end

function mlx_roll_all(res, a, shift, s)
    ccall((:mlx_roll_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, shift, s)
end

function mlx_round(res, a, decimals, s)
    ccall((:mlx_round, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, decimals, s)
end

function mlx_rsqrt(res, a, s)
    ccall((:mlx_rsqrt, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_scatter(res, a, indices, updates, axes, axes_num, s)
    ccall((:mlx_scatter, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Ptr{Cint}, Csize_t, Cint), res, a, indices, updates, axes, axes_num, s)
end

function mlx_scatter_add(res, a, indices, updates, axes, axes_num, s)
    ccall((:mlx_scatter_add, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Ptr{Cint}, Csize_t, Cint), res, a, indices, updates, axes, axes_num, s)
end

function mlx_scatter_max(res, a, indices, updates, axes, axes_num, s)
    ccall((:mlx_scatter_max, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Ptr{Cint}, Csize_t, Cint), res, a, indices, updates, axes, axes_num, s)
end

function mlx_scatter_min(res, a, indices, updates, axes, axes_num, s)
    ccall((:mlx_scatter_min, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Ptr{Cint}, Csize_t, Cint), res, a, indices, updates, axes, axes_num, s)
end

function mlx_scatter_prod(res, a, indices, updates, axes, axes_num, s)
    ccall((:mlx_scatter_prod, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Ptr{Cint}, Csize_t, Cint), res, a, indices, updates, axes, axes_num, s)
end

function mlx_sigmoid(res, a, s)
    ccall((:mlx_sigmoid, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_sign(res, a, s)
    ccall((:mlx_sign, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_sin(res, a, s)
    ccall((:mlx_sin, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_sinh(res, a, s)
    ccall((:mlx_sinh, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_slice(res, a, start, start_num, stop, stop_num, strides, strides_num, s)
    ccall((:mlx_slice, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, start, start_num, stop, stop_num, strides, strides_num, s)
end

function mlx_slice_update(res, src, update, start, start_num, stop, stop_num, strides, strides_num, s)
    ccall((:mlx_slice_update, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, src, update, start, start_num, stop, stop_num, strides, strides_num, s)
end

function mlx_softmax(res, a, axes, axes_num, precise, s)
    ccall((:mlx_softmax, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, precise, s)
end

function mlx_softmax_all(res, a, precise, s)
    ccall((:mlx_softmax_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, precise, s)
end

function mlx_sort(res, a, axis, s)
    ccall((:mlx_sort, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, axis, s)
end

function mlx_sort_all(res, a, s)
    ccall((:mlx_sort_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_split_equal_parts(res, a, num_splits, axis, s)
    ccall((:mlx_split_equal_parts, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, num_splits, axis, s)
end

function mlx_split(res, a, indices, indices_num, axis, s)
    ccall((:mlx_split, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, indices, indices_num, axis, s)
end

function mlx_sqrt(res, a, s)
    ccall((:mlx_sqrt, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_square(res, a, s)
    ccall((:mlx_square, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_squeeze(res, a, axes, axes_num, s)
    ccall((:mlx_squeeze, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint), res, a, axes, axes_num, s)
end

function mlx_squeeze_all(res, a, s)
    ccall((:mlx_squeeze_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_stack(res, arrays, axis, s)
    ccall((:mlx_stack, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, arrays, axis, s)
end

function mlx_stack_all(res, arrays, s)
    ccall((:mlx_stack_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, arrays, s)
end

function mlx_std(res, a, axes, axes_num, keepdims, ddof, s)
    ccall((:mlx_std, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, a, axes, axes_num, keepdims, ddof, s)
end

function mlx_std_all(res, a, keepdims, ddof, s)
    ccall((:mlx_std_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, keepdims, ddof, s)
end

function mlx_stop_gradient(res, a, s)
    ccall((:mlx_stop_gradient, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_subtract(res, a, b, s)
    ccall((:mlx_subtract, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, b, s)
end

function mlx_sum(res, a, axes, axes_num, keepdims, s)
    ccall((:mlx_sum, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, a, axes, axes_num, keepdims, s)
end

function mlx_sum_all(res, a, keepdims, s)
    ccall((:mlx_sum_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, keepdims, s)
end

function mlx_swapaxes(res, a, axis1, axis2, s)
    ccall((:mlx_swapaxes, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, axis1, axis2, s)
end

function mlx_take(res, a, indices, axis, s)
    ccall((:mlx_take, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, indices, axis, s)
end

function mlx_take_all(res, a, indices, s)
    ccall((:mlx_take_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, indices, s)
end

function mlx_take_along_axis(res, a, indices, axis, s)
    ccall((:mlx_take_along_axis, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, indices, axis, s)
end

function mlx_tan(res, a, s)
    ccall((:mlx_tan, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_tanh(res, a, s)
    ccall((:mlx_tanh, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_tensordot(res, a, b, axes_a, axes_a_num, axes_b, axes_b_num, s)
    ccall((:mlx_tensordot, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t, Cint), res, a, b, axes_a, axes_a_num, axes_b, axes_b_num, s)
end

function mlx_tensordot_along_axis(res, a, b, axis, s)
    ccall((:mlx_tensordot_along_axis, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, b, axis, s)
end

function mlx_tile(res, arr, reps, reps_num, s)
    ccall((:mlx_tile, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint), res, arr, reps, reps_num, s)
end

function mlx_topk(res, a, k, axis, s)
    ccall((:mlx_topk, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, k, axis, s)
end

function mlx_topk_all(res, a, k, s)
    ccall((:mlx_topk_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, k, s)
end

function mlx_trace(res, a, offset, axis1, axis2, dtype, s)
    ccall((:mlx_trace, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Cint), res, a, offset, axis1, axis2, dtype, s)
end

function mlx_transpose(res, a, axes, axes_num, s)
    ccall((:mlx_transpose, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint), res, a, axes, axes_num, s)
end

function mlx_transpose_all(res, a, s)
    ccall((:mlx_transpose_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end

function mlx_tri(res, n, m, k, type, s)
    ccall((:mlx_tri, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, n, m, k, type, s)
end

function mlx_tril(res, x, k, s)
    ccall((:mlx_tril, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, x, k, s)
end

function mlx_triu(res, x, k, s)
    ccall((:mlx_triu, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, x, k, s)
end

function mlx_var(res, a, axes, axes_num, keepdims, ddof, s)
    ccall((:mlx_var, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, a, axes, axes_num, keepdims, ddof, s)
end

function mlx_var_all(res, a, keepdims, ddof, s)
    ccall((:mlx_var_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, a, keepdims, ddof, s)
end

function mlx_view(res, a, dtype, s)
    ccall((:mlx_view, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, a, dtype, s)
end

function mlx_where(res, condition, x, y, s)
    ccall((:mlx_where, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, condition, x, y, s)
end

function mlx_zeros(res, shape, shape_num, dtype, s)
    ccall((:mlx_zeros, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Csize_t, Cint, Cint), res, shape, shape_num, dtype, s)
end

function mlx_zeros_like(res, a, s)
    ccall((:mlx_zeros_like, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, a, s)
end
...
function mlx_random_bernoulli(res, p, shape, shape_num, key, s)
    ccall((:mlx_random_bernoulli, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, p, shape, shape_num, key, s)
end

function mlx_random_bits(res, shape, shape_num, width, key, s)
    ccall((:mlx_random_bits, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, shape, shape_num, width, key, s)
end

function mlx_random_categorical_shape(res, logits, axis, shape, shape_num, key, s)
    ccall((:mlx_random_categorical_shape, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Cint, Cint), res, logits, axis, shape, shape_num, key, s)
end

function mlx_random_categorical_num_samples(res, logits_, axis, num_samples, key, s)
    ccall((:mlx_random_categorical_num_samples, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint), res, logits_, axis, num_samples, key, s)
end

function mlx_random_categorical(res, logits, axis, key, s)
    ccall((:mlx_random_categorical, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, logits, axis, key, s)
end

function mlx_random_gumbel(res, shape, shape_num, dtype, key, s)
    ccall((:mlx_random_gumbel, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, shape, shape_num, dtype, key, s)
end

function mlx_random_key(res, seed)
    ccall((:mlx_random_key, libmlxc), Cint, (Ptr{Cint}, Cint), res, seed)
end

function mlx_random_laplace(res, shape, shape_num, dtype, loc, scale, key, s)
    ccall((:mlx_random_laplace, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Csize_t, Cint, Cfloat, Cfloat, Cint, Cint), res, shape, shape_num, dtype, loc, scale, key, s)
end

function mlx_random_multivariate_normal(res, mean, cov, shape, shape_num, dtype, key, s)
    ccall((:mlx_random_multivariate_normal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, mean, cov, shape, shape_num, dtype, key, s)
end

function mlx_random_normal(res, shape, shape_num, dtype, loc, scale, key, s)
    ccall((:mlx_random_normal, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Csize_t, Cint, Cfloat, Cfloat, Cint, Cint), res, shape, shape_num, dtype, loc, scale, key, s)
end

function mlx_random_permutation(res, x, axis, key, s)
    ccall((:mlx_random_permutation, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, x, axis, key, s)
end

function mlx_random_permutation_all(res, x, key, s)
    ccall((:mlx_random_permutation_all, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, x, key, s)
end

function mlx_random_randint(res, low, high, shape, shape_num, dtype, key, s)
    ccall((:mlx_random_randint, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, low, high, shape, shape_num, dtype, key, s)
end

function mlx_random_seed(seed)
    ccall((:mlx_random_seed, libmlxc), Cint, (Cint,), seed)
end

function mlx_random_split_equal_parts(res, key, num, s)
    ccall((:mlx_random_split_equal_parts, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint), res, key, num, s)
end

function mlx_random_split(res_0, res_1, key, s)
    ccall((:mlx_random_split, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Cint, Cint), res_0, res_1, key, s)
end

function mlx_random_truncated_normal(res, lower, upper, shape, shape_num, dtype, key, s)
    ccall((:mlx_random_truncated_normal, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, lower, upper, shape, shape_num, dtype, key, s)
end

function mlx_random_uniform(res, low, high, shape, shape_num, dtype, key, s)
    ccall((:mlx_random_uniform, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t, Cint, Cint, Cint), res, low, high, shape, shape_num, dtype, key, s)
end
...
function mlx_stream_new_device(dev)
    ccall((:mlx_stream_new_device, libmlxc), mlx_stream, (Cint,), dev)
end
...
function mlx_stream_tostring(str, stream)
    ccall((:mlx_stream_tostring, libmlxc), Cint, (Ptr{Cint}, mlx_stream), str, stream)
end
...
function mlx_stream_get_device(dev, stream)
    ccall((:mlx_stream_get_device, libmlxc), Cint, (Ptr{Cint}, mlx_stream), dev, stream)
end
...
function mlx_get_default_stream(stream, dev)
    ccall((:mlx_get_default_stream, libmlxc), Cint, (Ptr{mlx_stream}, Cint), stream, dev)
end
...
function mlx_async_eval(outputs)
    ccall((:mlx_async_eval, libmlxc), Cint, (Cint,), outputs)
end

function mlx_checkpoint(res, fun)
    ccall((:mlx_checkpoint, libmlxc), Cint, (Ptr{Cint}, Cint), res, fun)
end

function mlx_custom_function(res, fun, fun_vjp, fun_jvp, fun_vmap)
    ccall((:mlx_custom_function, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Cint), res, fun, fun_vjp, fun_jvp, fun_vmap)
end

function mlx_custom_vjp(res, fun, fun_vjp)
    ccall((:mlx_custom_vjp, libmlxc), Cint, (Ptr{Cint}, Cint, Cint), res, fun, fun_vjp)
end

function mlx_eval(outputs)
    ccall((:mlx_eval, libmlxc), Cint, (Cint,), outputs)
end

function mlx_jvp(res_0, res_1, fun, primals, tangents)
    ccall((:mlx_jvp, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Cint, Cint, Cint), res_0, res_1, fun, primals, tangents)
end

function mlx_value_and_grad(res, fun, argnums, argnums_num)
    ccall((:mlx_value_and_grad, libmlxc), Cint, (Ptr{Cint}, Cint, Ptr{Cint}, Csize_t), res, fun, argnums, argnums_num)
end

function mlx_vjp(res_0, res_1, fun, primals, cotangents)
    ccall((:mlx_vjp, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Cint, Cint, Cint), res_0, res_1, fun, primals, cotangents)
end

function mlx_detail_vmap_replace(res, inputs, s_inputs, s_outputs, in_axes, in_axes_num, out_axes, out_axes_num)
    ccall((:mlx_detail_vmap_replace, libmlxc), Cint, (Ptr{Cint}, Cint, Cint, Cint, Ptr{Cint}, Csize_t, Ptr{Cint}, Csize_t), res, inputs, s_inputs, s_outputs, in_axes, in_axes_num, out_axes, out_axes_num)
end

function mlx_detail_vmap_trace(res_0, res_1, fun, inputs, in_axes, in_axes_num)
    ccall((:mlx_detail_vmap_trace, libmlxc), Cint, (Ptr{Cint}, Ptr{Cint}, Cint, Cint, Ptr{Cint}, Csize_t), res_0, res_1, fun, inputs, in_axes, in_axes_num)
end
...
function mlx_vector_array_new_data(data, size)
    ccall((:mlx_vector_array_new_data, libmlxc), mlx_vector_array, (Ptr{Cint}, Cint), data, size)
end

function mlx_vector_array_new_value(val)
    ccall((:mlx_vector_array_new_value, libmlxc), mlx_vector_array, (Cint,), val)
end

function mlx_vector_array_set_data(vec, data, size)
    ccall((:mlx_vector_array_set_data, libmlxc), Cint, (Ptr{mlx_vector_array}, Ptr{Cint}, Cint), vec, data, size)
end

function mlx_vector_array_set_value(vec, val)
    ccall((:mlx_vector_array_set_value, libmlxc), Cint, (Ptr{mlx_vector_array}, Cint), vec, val)
end

function mlx_vector_array_append_data(vec, data, size)
    ccall((:mlx_vector_array_append_data, libmlxc), Cint, (mlx_vector_array, Ptr{Cint}, Cint), vec, data, size)
end

function mlx_vector_array_append_value(vec, val)
    ccall((:mlx_vector_array_append_value, libmlxc), Cint, (mlx_vector_array, Cint), vec, val)
end

function mlx_vector_array_size(vec)
    ccall((:mlx_vector_array_size, libmlxc), Cint, (mlx_vector_array,), vec)
end

function mlx_vector_array_get(res, vec, idx)
    ccall((:mlx_vector_array_get, libmlxc), Cint, (Ptr{Cint}, mlx_vector_array, Cint), res, vec, idx)
end
...
function mlx_vector_vector_array_new_data(data, size)
    ccall((:mlx_vector_vector_array_new_data, libmlxc), mlx_vector_vector_array, (Ptr{mlx_vector_array}, Cint), data, size)
end
...
function mlx_vector_vector_array_set_data(vec, data, size)
    ccall((:mlx_vector_vector_array_set_data, libmlxc), Cint, (Ptr{mlx_vector_vector_array}, Ptr{mlx_vector_array}, Cint), vec, data, size)
end
...
function mlx_vector_vector_array_append_data(vec, data, size)
    ccall((:mlx_vector_vector_array_append_data, libmlxc), Cint, (mlx_vector_vector_array, Ptr{mlx_vector_array}, Cint), vec, data, size)
end
...
function mlx_vector_vector_array_size(vec)
    ccall((:mlx_vector_vector_array_size, libmlxc), Cint, (mlx_vector_vector_array,), vec)
end

function mlx_vector_vector_array_get(res, vec, idx)
    ccall((:mlx_vector_vector_array_get, libmlxc), Cint, (Ptr{mlx_vector_array}, mlx_vector_vector_array, Cint), res, vec, idx)
end
...
function mlx_vector_int_new_data(data, size)
    ccall((:mlx_vector_int_new_data, libmlxc), mlx_vector_int, (Ptr{Cint}, Cint), data, size)
end
...
function mlx_vector_int_set_data(vec, data, size)
    ccall((:mlx_vector_int_set_data, libmlxc), Cint, (Ptr{mlx_vector_int}, Ptr{Cint}, Cint), vec, data, size)
end
...
function mlx_vector_int_append_data(vec, data, size)
    ccall((:mlx_vector_int_append_data, libmlxc), Cint, (mlx_vector_int, Ptr{Cint}, Cint), vec, data, size)
end
...
function mlx_vector_int_size(vec)
    ccall((:mlx_vector_int_size, libmlxc), Cint, (mlx_vector_int,), vec)
end

function mlx_vector_int_get(res, vec, idx)
    ccall((:mlx_vector_int_get, libmlxc), Cint, (Ptr{Cint}, mlx_vector_int, Cint), res, vec, idx)
end
...
function mlx_vector_string_new_data(data, size)
    ccall((:mlx_vector_string_new_data, libmlxc), mlx_vector_string, (Ptr{Ptr{Cchar}}, Cint), data, size)
end
...
function mlx_vector_string_set_data(vec, data, size)
    ccall((:mlx_vector_string_set_data, libmlxc), Cint, (Ptr{mlx_vector_string}, Ptr{Ptr{Cchar}}, Cint), vec, data, size)
end
...
function mlx_vector_string_append_data(vec, data, size)
    ccall((:mlx_vector_string_append_data, libmlxc), Cint, (mlx_vector_string, Ptr{Ptr{Cchar}}, Cint), vec, data, size)
end
...
function mlx_vector_string_size(vec)
    ccall((:mlx_vector_string_size, libmlxc), Cint, (mlx_vector_string,), vec)
end

function mlx_vector_string_get(res, vec, idx)
    ccall((:mlx_vector_string_get, libmlxc), Cint, (Ptr{Ptr{Cchar}}, mlx_vector_string, Cint), res, vec, idx)
end
